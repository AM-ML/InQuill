...
const categories = [
  {
    ...
    color: "bg-red-500",
    href: "/articles?category=Cardiology",
  },
  {
    name: "Neurology",
    icon: Brain,
    ...
    color: "bg-purple-500",
    href: "/articles?category=Neurology",
  },
  {
    name: "Immunology",
    icon: Microscope,
    ...
    color: "bg-green-500",
    href: "/articles?category=Immunology",
  },
  {
    name: "Genetics",
    icon: Dna,
    ...
    color: "bg-blue-500",
    href: "/articles?category=Genetics",
  },
  {
  ...
  },
  {
    ...
    href: "/articles?category=Microbiology",
  },
]
